...
export function CompanyHeader({ company }: CompanyHeaderProps) {
  ...
  return (
    <div className="bg-[var(--secondary)] text-[var(--secondaryText)]">
      ...
      <div className="px-4 md:px-8 max-w-7xl mx-auto relative">
        <div className="flex flex-col md:flex-row items-start md:items-end -mt-12 mb-6 gap-6">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-sm border-4 border-[var(--secondary)] overflow-hidden relative bg-white shadow-sm">
            <Image
              src={company.logo}
          ...
          <div className="mb-4 md:mb-2">
            <button className="px-6 py-2 rounded-full font-medium text-white transition-opacity hover:opacity-90 bg-[var(--action)] text-[var(--actionText)]">
              Follow
            </button>
          </div>
        </div>
